    ...
    <div class="container">
        <div class="menu-content">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/"><img src="/public/images/logo.jpg" alt="" title="На главную"></a>
            </div>
                ...
                <div class="i_con">
                    <ul class="nav navbar-nav text-uppercase">
                        <?php if (Yii::$app->user->isGuest):?>
                            <li><a href="<?= Url::toRoute(['/auth/login']) ?>">Авторизация</a></li>
...
<footer class="footer-widget-section">
    ...
    <div class="footer-copy">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">&copy; 2017 <a href="/site/index">Rezume, </a> Built with <i
                                class="fa fa-heart"></i> by <a href="https://vk.com/sema_qq">Sema</a>
                    </div>
                </div>
            </div>
        </div>
